      ...
      return (
        <div style={{ textAlign: 'center', padding: '2rem', color: '#666', fontFamily: 'system-ui, sans-serif' }}>
          ...
          {this.props.feedbackUrl && (
            <p>
              <a href={this.props.feedbackUrl} target="_blank" rel="noopener noreferrer" style={{ color: '#666', textDecoration: 'underline' }}>
                Report this issue
              </a>
            </p>
          )}
...
if (typeof window !== 'undefined') {
  ...
  window.BracketGenerator = { version: '1.5.0', mount };
}
